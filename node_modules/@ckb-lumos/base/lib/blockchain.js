...
function deTransformTransactionCodecType(data) {
  return {
    cellDeps: data.raw.cellDeps.map(cellDep => {
      return {
        outPoint: {
          ...
          index: _bi.BI.from(cellDep.outPoint.index).toHexString()
        },
    ...
    inputs: data.raw.inputs.map(input => {
      return {
        previousOutput: {
          ...
          index: _bi.BI.from(input.previousOutput.index).toHexString()
        },
    ...
    version: _bi.BI.from(data.raw.version).toHexString(),
    witnesses: data.witnesses
  };
}
...
function deTransformHeaderCodecType(data) {
  return {
    ...
    compactTarget: _bi.BI.from(data.raw.compactTarget).toHexString(),
    dao: data.raw.dao,
